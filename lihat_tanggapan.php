...
<head>
  ...
  <title>APPEM - Lihat Tanggapan</title>
...
<a href="?url=lihat_pengaduan" class="kiri btn btn-info btn-icon-split"><span class="icon text-white-60">
<i class="kiri fas fa-arrow-left"></i></span></a>
<h5 class="tengah m-1 font-weight-bold text-info">Tanggapan Dari Pengaduan Anda</h5>
</div>
<div class="card-body">
