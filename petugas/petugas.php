  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <a href="petugas.php"><h5 class="kiri m-0 font-weight-bold text-info">&ensp;&ensp;&ensp;TENTANG <b>APPEM</b></h5></a>
       <h5 class="kanan m-0 font-weight-bold text-info"><b><i class="fas fa-user-cog text-info"></i> <?php echo $_SESSION['nama']; ?> &ensp;&ensp;&ensp;</b></h5>
