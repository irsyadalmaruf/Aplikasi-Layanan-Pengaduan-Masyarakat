...
<head>
  ...
  <title>LPM - Masuk atau Daftar</title>
...
<body class="bg">
  ...
  <div class="container">
    ...
    <!-- Outer Row -->
    <div class="row justify-content kanan">
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h2 class="h5 text-gray-900 mb-4"><b>MASUK</b><hr>
                  </div>
                  ...
                  <hr>
                    <a class="btn btn-success btn-user btn-block" href="register.php">BUAT AKUN BARU</a>
                    <a class="btn btn-primary btn-user btn-block" href="index2.php">ADMIN / PETUGAS</a>
                  </form>
                </div>
              </div>
            </div>
